  ...
  it('has a prefix between 622126 and 622925 and a length between 16 and 19', function() {
    ...
    for (var prefix = 622126; prefix <= 622925; prefix++){
      ...
      for (var length = 16; length <= 19; length++){
        cardnumber += restOfCardObj[length];
...
describe('Switch', function(){
  ...
  it ('has a prefix of 4903, 4905, 4911, 4936, 6333, 564182, 633110 or 6759 and a length of 16, 18, or 19', function(){
    var prefixFourArr = [4903, 4905, 4911, 4936, 6333, 6759];
    var restOfCardObj = {
        16 : "123456789012",
        18 : "12345678901234",
        19 : "123456789012345"
    };
    for (var x = 0; x < prefixFourArr.length; x++){
      var cardnumber = '';
      cardnumber += prefixFourArr[x];
      for (var length in restOfCardObj){
        cardnumber += restOfCardObj[length];
        expect(detectNetwork(cardnumber)).to.equal("Switch");
        cardnumber = prefixFourArr[x];
      }
    }
    var prefixSixArr = [564182, 633110];
    var restOfCardObj = {
        16 : "1234567890",
        18 : "123456789012",
        19 : "1234567890123"
    };
    for (var x = 0; x < prefixSixArr.length; x++){
      var cardnumber = '';
      cardnumber += prefixSixArr[x];
      for (var length in restOfCardObj){
        cardnumber += restOfCardObj[length];
        expect(detectNetwork(cardnumber)).to.equal("Switch");
        cardnumber = prefixSixArr[x];
